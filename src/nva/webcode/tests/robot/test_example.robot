...
#
#  $ bin/test -s nva.webcode -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src nva.webcode.testing.NVA_WEBCODE_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/nva/webcode/tests/robot/test_example.robot
#
